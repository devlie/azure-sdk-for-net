...
namespace Azure.IoT.DeviceUpdate
{
    ...
    public partial class Update
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="compatibility"/> or <paramref name="manifestVersion"/> is null. </exception>
        internal Update(IEnumerable<IDictionary<string, string>> compatibility, string manifestVersion, DateTimeOffset importedDateTime, DateTimeOffset createdDateTime)
        {
            Argument.AssertNotNull(compatibility, nameof(compatibility));
            Argument.AssertNotNull(manifestVersion, nameof(manifestVersion));
        ...
        internal Update(UpdateId updateId, string description, string friendlyName, bool? isDeployable, string updateType, string installedCriteria, IReadOnlyList<IDictionary<string, string>> compatibility, Instructions instructions, IReadOnlyList<UpdateId> referencedBy, string scanResult, string manifestVersion, DateTimeOffset importedDateTime, DateTimeOffset createdDateTime, string etag)
        {
            UpdateId = updateId;
        ...
        public IReadOnlyList<IDictionary<string, string>> Compatibility { get; }
        ...
        public IReadOnlyList<UpdateId> ReferencedBy { get; }

...
{
    /// <summary> DeviceClass Subgroup Deployment metadata. </summary>
    public partial class DeviceClassSubgroupDeployment
    {
        ...
        internal DeviceClassSubgroupDeployment(string deploymentId, DateTimeOffset startDateTime, UpdateInfo update, string groupId)
        {
        ...
        internal DeviceClassSubgroupDeployment(string deploymentId, DateTimeOffset startDateTime, UpdateInfo update, string groupId, IReadOnlyList<string> deviceClassSubgroups, bool? isCanceled, bool? isRetried, CloudInitiatedRollbackPolicy rollbackPolicy, bool? isCloudInitiatedRollback)
        {
            DeploymentId = deploymentId;
            StartDateTime = startDateTime;
            Update = update;
